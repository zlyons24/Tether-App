...
- AI assistant (Cortex) responses
- Healing protocols and recommendations
- Educational content about health conditions
- Sensitivity profile analysis

**IS FOR INFORMATIONAL AND EDUCATIONAL PURPOSES ONLY.**

This information should not be used as a substitute for professional medical advice, diagnosis, or treatment from qualified healthcare providers.

## Consult Healthcare Professionals

**ALWAYS** consult with a qualified healthcare provider:

- Before making any changes to your diet, supplements, or medications
- Before starting any new health protocols or treatments
- If you have concerns about any symptoms or health conditions
- For proper diagnosis of any medical condition
...
The Cortex AI assistant:

- Uses artificial intelligence to generate responses
- May provide inaccurate, incomplete, or outdated information
- Cannot evaluate your specific medical situation
- Is not a replacement for consultation with healthcare providers
...
- We make no guarantees about the accuracy, completeness, or timeliness of any content
- Health and medical knowledge evolves constantly
- Information that was accurate when written may become outdated
- Always verify important health information with qualified professionals

## Supplements and Protocols

Any mentions of supplements, healing protocols, or interventions in the App:
...
Threshold deals with sensitive health topics and conditions. If you are struggling with mental health issues, chronic illness, or other health challenges:

- Seek support from qualified mental health professionals
- Connect with appropriate support groups and resources
- Do not rely solely on an app for your wellbeing

## Acknowledgment

By using Threshold, you acknowledge that you have read, understood, and agree to this Health Disclaimer. You understand that:

1. The App is not a substitute for professional medical care
2. You should consult healthcare providers for medical advice
3. You are responsible for your own health decisions
4. PLACEHOLDER is not liable for any health outcomes from using the App
